...
<template>
  ...
  <transition name="fade">
    <aside
      class="fixed left-0 top-0 h-full w-64 bg-white border-r border-green-100 shadow-xl z-50 flex flex-col transition-transform duration-200 -translate-x-full md:translate-x-0"
      :class="{ 'translate-x-0': showSidebar }" v-show="showSidebar || isDesktop">
      <!-- Fechar no mobile -->
      ...
      <!-- Botão login/sair -->
      <div class="flex flex-col px-6 mb-8">
